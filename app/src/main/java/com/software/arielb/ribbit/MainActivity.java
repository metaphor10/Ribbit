        ...
        public void onClick(DialogInterface dialog, int which) {
            switch(which){
                ...
                case 3:
                    ...
                    Toast.makeText(MainActivity.this,getString(R.string.video_file_size_warnning),Toast.LENGTH_LONG).show();
            ...
            if (requestCode==PICK_PHOTO_REQUEST||requestCode==PICK_VIDEO_REQUEST){
                ...
                if(requestCode==PICK_VIDEO_REQUEST){
                    ...
                    if(fileSize>=FILE_SIZE_LIMIT){
                        Toast.makeText(this,getString(R.string.error_file_size_to_long),Toast.LENGTH_LONG).show();
                        return;
                    }
                }
            }else {
